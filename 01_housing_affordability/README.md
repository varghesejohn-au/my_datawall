...
## How to reproduce
1. Place raw downloaded files in `data/raw/`
2. Run `analysis.py` — it cleans, merges, computes ratios, and exports
   `output/affordability_clean.csv` (ready for Tableau)
3. Open `affordability_clean.csv` in Tableau Public, build dashboard per the
   layout notes in `tableau_dashboard_notes.md`
